...
public class main {
    ...
    public main(String[] args) {
        ...
        registerUser(loginData, "amit", "hello123");

        // Checking password for an existing user
        checkPassword(loginData, "shyam", "pass123");

        // Closing any resources if needed (e.g., Postgres connections)
    }
